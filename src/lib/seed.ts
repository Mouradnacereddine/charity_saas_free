...
export async function seedRealisticData() {
  ...
  const articles: Article[] = [
    ...
    { id: generateId(), reference: generateArticleReference(), name: 'Lit medicalise', nameAr: 'سرير طبي', category: cat1, categoryAr: 'طبي', quantity: 8, availableQuantity: 5, status: 'disponible', storageLocation: loc5, storageLocationAr: 'المستودع ج', condition: 'Bon', conditionAr: 'جيد', isPermanent: false, createdAt: new Date(now.getTime() - 86400000 * 95), updatedAt: now },
    { id: generateId(), reference: generateArticleReference(), name: 'Bequilles (paire)', nameAr: 'عكازات (زوج)', category: cat1, categoryAr: 'طبي', quantity: 25, availableQuantity: 22, status: 'disponible', storageLocation: loc1, storageLocationAr: 'المستودع أ - الرف 1', condition: 'Neuf', conditionAr: 'جديد', isPermanent: false, createdAt: new Date(now.getTime() - 86400000 * 90), updatedAt: now },
    { id: generateId(), reference: generateArticleReference(), name: 'Deambulateur', nameAr: 'مشاية', category: cat1, categoryAr: 'طبي', quantity: 10, availableQuantity: 7, status: 'disponible', storageLocation: loc2, storageLocationAr: 'المستودع أ - الرف 2', condition: 'Neuf', conditionAr: 'جديد', isPermanent: false, createdAt: new Date(now.getTime() - 86400000 * 85), updatedAt: now },
    { id: generateId(), reference: generateArticleReference(), name: 'Cartable scolaire', nameAr: 'حقيبة مدرسية', category: cat2, categoryAr: 'مدرسي', quantity: 50, availableQuantity: 50, status: 'disponible', storageLocation: loc3, storageLocationAr: 'المستودع ب - الرف 1', condition: 'Neuf', conditionAr: 'جديد', isPermanent: false, createdAt: new Date(now.getTime() - 86400000 * 80), updatedAt: now },
    { id: generateId(), reference: generateArticleReference(), name: 'Kit fournitures scolaires', nameAr: 'حقيبة أدوات مدرسية', category: cat2, categoryAr: 'مدرسي', quantity: 100, availableQuantity: 100, status: 'disponible', storageLocation: loc3, storageLocationAr: 'المستودع ب - الرف 1', condition: 'Neuf', conditionAr: 'جديد', isPermanent: false, createdAt: new Date(now.getTime() - 86400000 * 75), updatedAt: now },
    { id: generateId(), reference: generateArticleReference(), name: 'Colis alimentaire Ramadan', nameAr: 'سلة غذائية (رمضان)', category: cat3, categoryAr: 'غذائي', quantity: 200, availableQuantity: 200, status: 'disponible', storageLocation: loc4, storageLocationAr: 'المستودع ب - الرف 2', condition: 'Neuf', conditionAr: 'جديد', isPermanent: true, createdAt: new Date(now.getTime() - 86400000 * 70), updatedAt: now },
    { id: generateId(), reference: generateArticleReference(), name: 'Couverture polaire', nameAr: 'بطانية صوفية', category: cat4, categoryAr: 'ملبس', quantity: 80, availableQuantity: 75, status: 'disponible', storageLocation: loc3, storageLocationAr: 'المستودع ب - الرف 1', condition: 'Neuf', conditionAr: 'جديد', isPermanent: true, createdAt: new Date(now.getTime() - 86400000 * 65), updatedAt: now },
    { id: generateId(), reference: generateArticleReference(), name: 'Vetements enfants (lot)', nameAr: 'ملابس أطفال (مجموعة)', category: cat4, categoryAr: 'ملبس', quantity: 60, availableQuantity: 60, status: 'disponible', storageLocation: loc4, storageLocationAr: 'المستودع ب - الرف 2', condition: 'Neuf', conditionAr: 'جديد', isPermanent: false, createdAt: new Date(now.getTime() - 86400000 * 60), updatedAt: now },
    { id: generateId(), reference: generateArticleReference(), name: 'Matelas orthopedique', nameAr: 'فراش طبي', category: cat5, categoryAr: 'أثاث', quantity: 5, availableQuantity: 3, status: 'disponible', storageLocation: loc5, storageLocationAr: 'المستودع ج', condition: 'Bon', conditionAr: 'جيد', isPermanent: false, createdAt: new Date(now.getTime() - 86400000 * 55), updatedAt: now },
  ];
