/**
 * Test d'interpolation réelle de <Trans> pour les recommandations Smart Analytics.
 * Garde-fou contre une régression du bug "{ratio}" affiché en dur (commits 941cc78
 * puis re-correctif) : valide que les variables nommées sont bien interpolées
 * quand le locale contient des balises <strong>.
 */
...
describe('Interpolation Smart Analytics via <SmartText>', () => {
  it('interpole {ratio} dans excellentText (locale avec <strong>)', () => {
    render(
      <div data-testid="p">
